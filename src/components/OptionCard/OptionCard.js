...
const OptionCard = ({ option, id, notify }) => {
    ...
    return (
        <div className="flex items-center px-4 rounded border border-rose-600 bg-zinc-200">
            <input onClick={() => notify(option)} id={id} type="radio" value="" name="bordered-radio" className="w-4 h-4 text-rose-600 bg-white border-rose-400 focus:ring-rose-700 focus:ring-2" />
